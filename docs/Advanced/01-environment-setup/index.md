...
> [1.1 代码格式演变](./01-代码格式演变.md) 会带你从单文件 HTML 走向现代模块化开发。
...
> [1.2 技术栈概念](./02-技术栈概念.md) 和 [1.3 浏览器与服务器基础](./03-浏览器与服务器基础.md) 会帮你建立这些认知。
...
> [1.4 Terminal 终端入门](./04-Terminal终端入门.md) 会教你掌握命令行的基本操作，[1.5 Node.js 环境与包管理](./05-Node.js环境与包管理.md) 会带你完成这些配置。
...
> [1.8 Localhost 与端口](./08-Localhost与端口.md) 会详细讲解这些网络基础。
...
> [1.6 模型与工具](./06-模型与工具.md) 会详细介绍各类开发工具的选择和配置。
