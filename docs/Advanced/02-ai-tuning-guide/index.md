...
> [2.1 AI 编程的经济学](./01-AI编程的经济学.md) 会详细讲解成本优化策略。
...
> [2.2 VibeCoding 工作流](./02-VibeCoding工作流.md) 会详细讲解提示词心法和标准开发流程。
...
> [2.3 MCP、插件与 Skills](./03-MCP插件与Skills.md) 和 [2.4 项目规则配置](./04-项目规则配置.md) 会详细讲解这些配置技巧。
...
> [2.5 高效调试心法](./05-高效调试心法.md) 会教你这套完整的调试方法。
