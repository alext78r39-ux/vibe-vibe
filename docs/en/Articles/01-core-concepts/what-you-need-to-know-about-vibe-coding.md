---
title: What You Need to Know About Vibe Coding
description: Vercel's State of Vibe Coding report—how AI-powered development is reshaping who builds software and how
...
**Original: [Read the full article](https://vercel.com/blog/what-you-need-to-know-about-vibe-coding)**

<div class="article-meta">
</div>

Vibe coding is rapidly changing how software gets built. This article draws from Vercel's [State of Vibe Coding Report](https://v0.app/vibecoding), highlighting the key takeaways.

In February 2025, Andrej Karpathy [coined](https://x.com/karpathy/status/1886192184808149383?lang=en) the term *vibe coding*: a new way of programming with AI—"surrendering to the vibes, embracing exponential speedups, and even forgetting that the code itself exists."

Within months, vibe coding had noticeably changed how both developers and non-developers work. [Over 90%](https://github.blog/news-insights/research/survey-reveals-ais-impact-on-the-developer-experience/) of US developers now use AI coding tools, with adoption rising rapidly across other roles as well. The notion that "English is the fastest-growing programming language" is no longer just a joke.
...
Today, vibe coding tools like v0, Lovable, and [Replit](https://v0.app/docs/compare/v0-vs-replit) push this path further, into a "what you say is what you get" era: you describe what you want, and the system generates the application, website, or workflow. The barrier continues to drop, and with it, team collaboration patterns, project division of labor, and the boundaries of what individuals can accomplish on their own are all shifting.

## Core Advantages of Vibe Coding

Increasingly, major companies are openly embracing vibe coding. Amazon launched its own tool, [Kiro](https://kiro.dev/blog/introducing-kiro/), and [over 30%](https://abc.xyz/assets/66/ae/c94682fc4137b5fb90a5d709ac4b/2025-q1-earnings-transcript.pdf) of Google's new code is now generated with AI involvement. But this shift isn't limited to big tech.

Teams of all sizes can now complete in days what previously took months. For example, in March 2025, [Garry Tan noted](https://www.cnbc.com/2025/03/15/y-combinator-startups-are-fastest-growing-in-fund-history-because-of-ai.html) that a 10-person AI-powered team can now produce what previously required 100 engineers. Vibe coding is compressing the minimum unit of productivity from "team" to "individual."
...
Whatever you think of the name, this shift is already happening. To learn more, check out the full [State of Vibe Coding Report](https://v0.app/vibecoding).
